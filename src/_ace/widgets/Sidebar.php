...
class Sidebar extends \kordar\yak\widgets\YakWidget
{
    public function render()
    {
        ...
        $sideBarTree = new AceTree(new MenuIterator($this->widget->tree), \RecursiveIteratorIterator::SELF_FIRST);
        ...
        $this->widget->view->registerJs('$(\'#sidebar li.active\').parents(\'li\').addClass(\'active open\')');
