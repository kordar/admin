...
<div class="box-body">
    ...
    <?= $form->field($model, 'parent_id')->widget('kordar\yak\widgets\form\Select', [
        'type' => 'chosen',
    ...
    <?= $form->field($model, 'active')->widget('kordar\yak\widgets\form\Radio', ['items' => YakHelper::dropDownListYOrN()]) ?>

    <?= $form->field($model, 'hidden')->widget('kordar\yak\widgets\form\Radio', ['items' => YakHelper::dropDownListYOrN()]) ?>
