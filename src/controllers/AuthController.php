...
use kordar\yak\models\auth\SignupForm;
use kordar\yak\helpers\ActiveFormHelper AS AppHelper;
...
class AuthController extends YakController
{
    ...
    public function init()
    {
        ...
        $this->layout = '@kordar/yak/views/layouts/' . $this->template . '/auth.php';
    ...
    public function actionLogin()
    {
        ...
        $model = new \kordar\yak\models\auth\LoginForm();
    ...
    public function actionError()
    {
        ...
        if ($exception !== null) {
            $this->layout =  '@kordar/yak/views/layouts/blank.php';
