...
<div class="card">
    ...
    <div class="card-header">
        <?= YakHelper::renderLinker(Yii::t('yak', 'Update'), ['update-permission', 'id' => $model->name], ['class' => 'btn btn-primary'], 'fa-edit') ?>
        <?= YakHelper::renderLinker(Yii::t('yak', 'Delete'), ['delete-permission', 'id' => $model->name], ['class' => 'btn btn-danger', 'data' => [
