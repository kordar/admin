<?php
namespace kordar\yak\widgets\search;

use kordar\yak\assets\WDatePicketAsset;
...
class DropDownDateSearch extends \yii\base\Widget
{
     ...
     * @var string
     */
    public $selectName = 'yak_dt';

    /**
     * @var string
     */
    public $selectStartName = 'yak_dt_s';

    /**
     * @var string
     */
    public $selectEndName = 'yak_dt_e';
